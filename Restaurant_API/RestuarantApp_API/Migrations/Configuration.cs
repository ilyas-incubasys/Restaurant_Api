namespace RestuarantApp_API.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<RestuarantApp_API.Context.RestaurantContext>
    {
        ...
        protected override void Seed(RestuarantApp_API.Context.RestaurantContext context)
        {
            ...
            //       CreatedBy = "ilyas khan",
            //       CreatedDate = DateTime.Now,
            //       SubCategories = new List<SubCategory>() { new SubCategory { Id = 3, Name = "NIHARI", ImageUrl = "images/err.jpg", CreatedBy = "ilyas khan", CreatedDate = DateTime.Now } }
            //   });
            //var subCategory = context.SubCategories.Where(s => s.Id == 3).ToList();
            //context.Categories.AddOrUpdate(x => x.Id,
            //  new Category
            //  {
            //      Id = 3,
            ...
            //        Address = "fordous market gulbeg III",
            //        CreatedDate = DateTime.Now
            //    }
            //    );
